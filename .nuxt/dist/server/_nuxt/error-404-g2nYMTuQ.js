...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "/workspaces/nuxt/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
...
import { u as useHead } from "./v3-BU3dqo76.js";
import "node:http";
import "node:https";
import "node:zlib";
import "node:stream";
...
import "/workspaces/nuxt/node_modules/.pnpm/@unhead+vue@2.0.10_vue@3.5.16_typescript@5.8.3_/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-eb3f5d5c><div class="fixed left-0 right-0 spotlight z-10" data-v-eb3f5d5c></div><div class="max-w-520px text-center z-20" data-v-eb3f5d5c><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-eb3f5d5c>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-eb3f5d5c>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-eb3f5d5c>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.4_@parcel+watcher@2.5.1_@types+node@22.15.29_db0@0.3.2_ioredis@5.6.1_lightnin_ad3efa013d1f13e06ffaa568dfd1c543/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eb3f5d5c"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-g2nYMTuQ.js.map
