...
import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, shallowRef, watch, nextTick, onServerPrefetch, createElementBlock, provide, cloneVNode, toValue, unref, useSSRContext, mergeProps, createVNode, resolveDynamicComponent, onErrorCaptured, createApp } from "vue";
...
import destr from "/workspaces/nuxt/landing/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { withBase, withQuery, hasProtocol, joinURL, isScriptProtocol, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from "/workspaces/nuxt/landing/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/workspaces/nuxt/landing/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext } from "/workspaces/nuxt/landing/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/workspaces/nuxt/landing/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs";
import { toRouteMatcher, createRouter } from "/workspaces/nuxt/landing/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
import { defu, defuFn } from "/workspaces/nuxt/landing/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { klona } from "/workspaces/nuxt/landing/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
...
import { useHead as useHead$1, headSymbol } from "/workspaces/nuxt/landing/node_modules/.pnpm/@unhead+vue@2.0.10_vue@3.5.16_typescript@5.8.3_/node_modules/@unhead/vue/dist/index.mjs";
import { debounce } from "/workspaces/nuxt/landing/node_modules/.pnpm/perfect-debounce@1.0.0/node_modules/perfect-debounce/dist/index.mjs";
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import("./_nuxt/multipart-parser-CnNmUxzA.js");
...
function createAsyncData(nuxtApp, key, _handler, options, initialCachedData) {
  ...
  const handler = !import.meta.prerender || !((_b2 = nuxtApp.ssrContext) == null ? void 0 : _b2._sharedPrerenderCache) ? _handler : () => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B6N38xKo.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BKMxHSAk.js"));
